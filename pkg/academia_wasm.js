 ...
 * @returns {string}
 */
export function detectar_topicos(texto) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {string}
 */
export function extract_authors_fast(texto) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
/**
 * @param {string} texto
 * @param {number} num_oraciones
 * @returns {string}
 */
export function resumir_texto(texto, num_oraciones) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
